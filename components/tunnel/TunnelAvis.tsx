  ...
  return (
    <section className="tunnel-avis" aria-label="Avis clients pompe à chaleur">
      <style>{`
        ...
        .tunnel-avis__title{ font-size:clamp(22px,3.4vw,30px); font-weight:600; color:#1B2841; margin:0; letter-spacing:-0.01em; }
        .tunnel-avis__grid{ display:flex; flex-wrap:wrap; justify-content:center; gap:16px; max-width:900px; margin:0 auto; }
        .tunnel-avis__card{ flex:1 1 320px; max-width:420px; background:#fff; border:1px solid rgba(27, 40, 65,0.08);
        ...
        .tunnel-avis__name{ font-weight:600; color:#1B2841; font-size:14px; }
